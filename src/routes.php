...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/projects/invoiced/{id}/show/{offset}',               ['as' => 'showProjectsInvoiced',               'uses' => 'Syscover\Projects\Controllers\InvoicedController@showRecord',              'resource' => 'projects-invoiced',        'action' => 'access']);
